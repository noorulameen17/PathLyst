                ...
                <AnimatePresence>
                  {isVisible.hero && (
                    <>
                      ...
                      >
                        Career Clarity Meets <AuroraText>AI Power</AuroraText>
                      </motion.h1>
                      <motion.p
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                      ...
                      >
                        ...
                        career path and get comprehensive insights.
                      </motion.p>
                      <motion.div
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                ...
                <>
                  ...
                  >
                    ...
                    >
                      ...
                      <p className="text-slate-600 mb-4">
                        Receive a detailed breakdown of the career, including
                        role description, skills, salary, and more.
                      </p>
                      <div className="bg-teal-50 rounded-lg p-3 border border-teal-200">
              ...
              {isVisible.audience && (
                <>
                  <motion.div
                    ...
                    className="text-center mb-16"
                  >
                    <div className="inline-flex items-center px-6 py-1 rounded-full bg-teal-100 text-teal-800 text-sm font-medium mb-4">
                      <Users className="h-4 w-4 mr-2" />
                      <span>Target Audience</span>
                    </div>
                    <h2 className="text-3xl text-slate-900 font-[FKDisplay] sm:text-4xl font-bold">
                      Perfect For
                    </h2>
                    <p className="mt-4 text-xl text-slate-600 max-w-3xl mx-auto">
                  ...
                  >
                    {audiences.map((audience, index) => (
                      <motion.div
                        ...
                        transition={{ duration: 0.5, delay: 0.1 * index }}
                        whileHover={{ y: -5 }}
                        className="bg-teal-800 rounded-xl p-6 border border-teal-100 hover:bg-teal-600 transition-all"
                      >
                        ...
                        <p className="text-white">{audience.description}</p>
                      </motion.div>
                    ))}
                  </motion.div>
                </>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-center">
                    <div className="lg:col-span-3 text-left">
                      <motion.div
                        ...
                        transition={{ duration: 0.5 }}
                      >
                        <div className="inline-flex items-center px-3 py-1 rounded-full bg-gradient-to-br from-slate-300 to-blue-400 text-slate-50 text-sm font-medium mb-4">
                          <Sparkles className="h-4 w-4 mr-2" />
                          <span>AI-Powered Career Guidance</span>
                        </div>
                        ...
                        <div className="flex justify-center mb-4 md:-translate-x-32  text-white">
